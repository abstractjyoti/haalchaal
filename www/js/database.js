...
db.transaction(function (tx) {
    tx.executeSql("insert into combinational_question values(?,?,?,?,?,?,'text',?,2,?)", [39,"You are on an aircraft and suddenly the airhostess announces that it has been hijacked by the terrorists. Everyone is in a state of shock. What will be your reaction? ", "Blame yourself for choosing an inauspicious day for travelling.|5", "Be in emotional control and attend to the instructions of the pilot/air hostess.|20", "Continue to read your magazine and pay little attention to the incident.|15", "Cry out and vow not to travel by air in future.|10", 11, 1]);
});
db.transaction(function (tx) {
...
db.transaction(function (tx) {
    tx.executeSql("insert into combinational_question values(?,?,?,?,?,?,'text',?,2,?)", [54, "As an HRD manager you have to recruit a large number of employees for a multi national firm. After the written test and interview you find that most of candidates who qualified are women. What will be your reaction? ", "Hire women employees. They deserve it as they have qualified the selection criteria.|20", "Well it’s a women’s world. Hire them any way.|15", "Hire male and female employees in equal number.|10", "Avoid women employees as they are a liability.|5", 9, 1]);
});
